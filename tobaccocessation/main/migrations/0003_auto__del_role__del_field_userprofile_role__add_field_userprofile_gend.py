...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_userprofile', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.is_faculty'
        db.add_column(u'main_userprofile', 'is_faculty',
        ...
        # Adding field 'UserProfile.specialty'
        db.add_column(u'main_userprofile', 'specialty',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.year_of_graduation'
        db.add_column(u'main_userprofile', 'year_of_graduation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'main_userprofile', 'gender')

        # Deleting field 'UserProfile.is_faculty'
        db.delete_column(u'main_userprofile', 'is_faculty')

        # Deleting field 'UserProfile.institute'
        db.delete_column(u'main_userprofile', 'institute')

        # Deleting field 'UserProfile.specialty'
        db.delete_column(u'main_userprofile', 'specialty')

        # Deleting field 'UserProfile.year_of_graduation'
        db.delete_column(u'main_userprofile', 'year_of_graduation')
    ...
    models = {
        ...
        u'main.userprofile': {
            ...
            'year_of_graduation': ('django.db.models.fields.DateField', [], {'null': 'True'})
        },
