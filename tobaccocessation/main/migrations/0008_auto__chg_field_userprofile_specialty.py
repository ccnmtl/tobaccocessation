...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.specialty'
        db.alter_column(u'main_userprofile', 'specialty', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.specialty'
        db.alter_column(u'main_userprofile', 'specialty', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    models = {
        ...
        u'main.userprofile': {
            ...
            'specialty': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
