...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserVisit', fields ['section', 'user']
        db.delete_unique(u'main_uservisit', ['section_id', 'user_id'])

        # Deleting field 'UserVisit.user'
        db.delete_column(u'main_uservisit', 'user_id')


    def backwards(self, orm):
        # Adding field 'UserVisit.user'
        db.add_column(u'main_uservisit', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 12, 3, 0, 0), to=orm['auth.User']),
                      keep_default=False)

        # Adding unique constraint on 'UserVisit', fields ['section', 'user']
        db.create_unique(u'main_uservisit', ['section_id', 'user_id'])
