...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.hispanic_latino'
        db.add_column(u'main_userprofile', 'hispanic_latino',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)


        # Changing field 'UserProfile.year_of_graduation'
  

    def backwards(self, orm):
        # Deleting field 'UserProfile.hispanic_latino'
        db.delete_column(u'main_userprofile', 'hispanic_latino')
