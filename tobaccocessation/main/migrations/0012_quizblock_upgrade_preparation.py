...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # In order to migrate from a very old version of quizblock, there are a few manual things to do:
        # 1. add allow_redo to the Quiz
        cursor = connection.cursor()

        # 2. kill the video references
        cursor.execute("alter table quizblock_quiz add column allow_redo boolean not null default true")
        cursor.execute("alter table quizblock_question drop column video")
        cursor.execute("alter table quizblock_answer drop column video")
