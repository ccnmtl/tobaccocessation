...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Block.show_correct'
        db.delete_column(u'activity_prescription_writing_block', 'show_correct')


    def backwards(self, orm):
        # Adding field 'Block.show_correct'
        db.add_column(u'activity_prescription_writing_block', 'show_correct',
