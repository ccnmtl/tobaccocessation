...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Block.allow_redo'
        db.add_column(u'activity_prescription_writing_block', 'allow_redo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Block.allow_redo'
        db.delete_column(u'activity_prescription_writing_block', 'allow_redo')
