...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PatientAssessmentBlock'
        db.create_table(u'activity_virtual_patient_patientassessmentblock', (
        ...
        db.send_create_signal(u'activity_virtual_patient', ['PatientAssessmentBlock'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PatientAssessmentBlock'
        db.delete_table(u'activity_virtual_patient_patientassessmentblock')
