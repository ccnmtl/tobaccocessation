...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreatmentOptionReasoning.display_order'
        db.add_column(u'activity_virtual_patient_treatmentoptionreasoning', 'display_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreatmentOptionReasoning.display_order'
        db.delete_column(u'activity_virtual_patient_treatmentoptionreasoning', 'display_order')
